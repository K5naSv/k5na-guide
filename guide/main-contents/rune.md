...
룬의 등급의 따라서 룬을 비밀의 가루 한 개로 거래 가능합니다. \
비밀의 가루 우클릭 시 이상한 가루 또는 마법의 가루가 나옵니다. \
→ 비밀의 가루에서 나오는 마법의 가루의 성공 확률 증가 퍼센트는 최대 <mark style="color:blue;">**15%**</mark> 입니다.
...
<figure><img src="../../.gitbook/assets/rune_alchemist_image.png" alt=""><figcaption></figcaption></figure>

**룬을 보다 좋게 강화하고 싶으신가요? 마력의 룬 공방 페이지를 이용해 보세요!**

성공 확률과 룬의 레벨이 높을수록 더 많은 경험치 비용이 요구됩니다.

* 예시) 굳건함 I (70%) + 굳건함 I (50%) → **굳건함 II (60%)** \
  합성된 룬의 성공 확률은 합성에 사용된 두 룬의 평균 성공 확률입니다. \
  굳건함 II + 굳건함 II = **굳건함 III**

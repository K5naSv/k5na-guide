...
| ------------------------------------------ | --------------------------- |
| **/pw**                                    | 워프 GUI(창) 열기합니다.            |
| **/pw help**                               | 유저워프 도움말을 확인합니다.            |
| **/pw \[워프이름]**                            | 해당 워프로 이동합니다.               |
| **/pw set \[워프이름]**                        | 워프를 등록합니다.                  |
| **/pw remove \[워프이름]**                     | 해당 워프를 삭제합니다.               |
| **/pw rename \[워프이름] \[새이름]**              | 해당 워프 이름 변경합니다.             |
| **/pw setowner \[워프이름]**                   | 해당 유저에게 워프 소유권을 양도합니다.      |
| **/pw reset \[워프이름]**                      | 해당 워프의 위치를 서있는 곳으로 재설정합니다.  |
| **/pw descs set/remove \[워프이름] \[설명]**     | 해당 워프에 대한 \[설명]을 설정/제거합니다.  |
| **/pw ban set/remove/list \[워프이름] \[닉네임]** | 특정 유저를 해당워프에 오지 못하도록 설정합니다. |
| **/pw rate \[워프이름] \[1\~5]**               | 해당 워프에 1\~5점의 평점을 줍니다.      |
| **/pw favourite \[워프이름]**                  | 해당 워프를 즐겨찾기 워프 목록에 추가합니다.   |

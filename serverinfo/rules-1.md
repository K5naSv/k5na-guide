...
1. **부적절한 닉네임 및 스킨: **<mark style="background-color:orange;">**변경 전까지 영구밴**</mark>\
   부적절한 닉네임 및 스킨(욕설, 선정적 등)을 사용하는 유저는 처벌됩니다.
2. **사기: **<mark style="background-color:orange;">**경고 7회 \~2차 기간밴**</mark>\
   알바 임금 관련, 아이템 거래 관련 등\
   유저간 합의한 부분을 제대로 이행하지 않는 경우 사기로 처벌됩니다.&#x20;
3. **현금거래: **<mark style="background-color:orange;">**2차 기간밴\~영구밴**</mark>\
   인게임 내 아이템이나 재화 등을 실제 돈(현금 등)으로 거래하는 경우\
   구매자와 판매자 모두 처벌됩니다.&#x20;
4. **무한회로 및 자동회로: **<mark style="background-color:orange;">**1차 기간밴\~2차 기간밴 + 강제철거**</mark>\
   ON/OFF 스위치가 없는 자동화 기계 또는 무한회로를 제작 시 처벌됩니다.\
   (제작비용, 회로 안에 이용 중이던 아이템 등의 복구는 불가합니다.)&#x20;
5. **버그악용 및 유포, 핵, 매크로, 엑스레이, 오토마우스: **<mark style="background-color:orange;">**2차 기간밴\~영구밴**</mark>\
...
1. **다른 유저의 플레이를 방해하는 행위: **<mark style="background-color:orange;">**경고 7회\~10회**</mark>\
   ① 유저를 따라다니면서 방해하는 행위 \
   ② 거절 의사를 표해도 지속적인 TPA 요청, 귓속말 등을 보내는 행위\
   ③ 사냥 중일 때 막타만을 노리거나 시도하는 행위\
   ④ 사냥 중인 유저의 아이템을 고의적으로 스틸하는 행위\
   ④의 기준이 모호할 수 있어 주인이 돌려달라 <mark style="color:red;">**명확히**</mark> 요청했지만\
   &#x20;     돌려주지 않았을 경우에만 고의적으로 스틸한 것으로 판단함&#x20;
2. **창작물 관련: **<mark style="background-color:orange;">**1차 기간밴\~영구밴 + 강제철거**</mark>\
   ① 특정인을 비방 또는 정치적인 성향이거나 선정적일 경우 \
   ② 인게임 내 다른 유저가 만든 창작물을 모방했을 경우&#x20;
3. **몹타워 혹은 몹 사냥터 건설: **<mark style="background-color:orange;">**경고 7회\~10회 + 강제철거**</mark>\
   몬스터를 편리하게 사냥하기 위해 낙사를 이용한 몹타워 등 \
   몬스터와 관련된(크리퍼 사냥터, 엘더 가디언 사냥터 등)\
   모든 건축물을 건설 시 처벌됩니다.&#x20;
4. **부계정 사용 및 추천사이트 부정 추천: **<mark style="background-color:orange;">**2차 기간밴\~영구밴**</mark>\
...
5. **엔티티 제한: **<mark style="background-color:orange;">**경고 3회\~7회**</mark>\
   본 서버에서는 서버 최적화 및 렉 요소를 줄이기 위해 일부 엔티티를 제한합니다.\
   1청크(x:16 X y:최하\~최상까지 X z:16) 당으로 제한하며 이를 위반할 시 처벌됩니다.

<table><thead><tr><th width="224.66666666666663">구분</th><th>개수</th><th>비고</th></tr></thead><tbody><tr><td>아이템액자</td><td>40개</td><td><br></td></tr><tr><td>갑옷거치대</td><td>30개</td><td><br></td></tr><tr><td>그림, 보트, 마인카트</td><td>10개</td><td><br></td></tr><tr><td>동물류(모든 종류 포함)</td><td>10마리</td><td><br></td></tr><tr><td>깔대기</td><td>20개</td><td><br></td></tr><tr><td>주민</td><td>5명</td><td><br></td></tr><tr><td>눈사람, 철골렘</td><td>5마리</td><td><br></td></tr><tr><td>몬스터류</td><td>5마리</td><td><br></td></tr><tr><td>벌집</td><td>5개</td><td><br></td></tr></tbody></table>
...
{% tab title="복구 불가" %}
{% hint style="warning" %}
서버 오류로 인한 유실만 복구가 가능하며, 아래에 미리 안내된 사항은 복구가 불가능합니다.\
또한, 개인 과실로 인한 유실은 복구가 불가능합니다.
{% endhint %}
...
{% tab title="🗨️커뮤니티" %}
**카페 및 디스코드 관련: **<mark style="background-color:orange;">**경고 3회\~5회**</mark>\
